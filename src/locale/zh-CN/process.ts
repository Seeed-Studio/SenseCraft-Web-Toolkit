export default {
  ...
  'workplace.device.model.ip.address': 'IP 地址',
  'workplace.device.model.server.state.0': 'MQTT未初始化或未连接',
  'workplace.device.model.server.state.1': 'MQTT连接但配置旧',
  'workplace.device.model.server.state.2': 'MQTT已连接,配置已更新',
  'workplace.device.model.server.state': '服务状态',
