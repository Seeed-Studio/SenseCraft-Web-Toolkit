<template>
  <div class="navbar">
    <div class="left-side">
      <a-space>
        <img alt="logo" src="@/assets/logo.png" style="width: 33px; height: 33px" />
    ...
    <ul class="right-side">
      <li>
        <a-tooltip :content="$t('settings.navbar.faq')">
          <a-button class="nav-btn" type="outline" :shape="'circle'" @click="handleFaq">
            <template #icon>
              <icon-question />
            </template>
          </a-button>
      ...
      <li>
        <a-tooltip :content="log ? $t('settings.navbar.log.toHide')
          : $t('settings.navbar.log.toShow')
          ">
          <a-button :class="['nav-btn', log ? 'focus' : '']" type="outline" :shape="'circle'" @click="handleToggleLog">
            <template #icon>
              <icon-file />
            </template>
          </a-button>
